...
Thin **Playwright** integration for [fixture-gen](https://github.com/arjvand/fixture-gen) — deterministic, schema-agnostic fixtures via `test.extend`.
...
See `examples/playwright.ts` in the fixture-gen repository.
