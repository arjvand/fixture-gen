...
Thin **Vitest** integration for [fixture-gen](https://github.com/arjvand/fixture-gen) — deterministic, schema-agnostic test fixtures with automatic seed reset per test.
...
See `examples/vitest.ts` in the fixture-gen repository.
